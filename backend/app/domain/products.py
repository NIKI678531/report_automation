...
REQUIRED_COLUMNS = {
    ...
    "fund_total_return_instrument_code",
    "fund_kpi_product_code",
    ...
    for line_number, raw in enumerate(reader, start=2):
        try:
            ...
            products.append({
                ...
                "fund_total_return_instrument_code": required(raw, "fund_total_return_instrument_code").upper(),
                "fund_kpi_product_code": required(raw, "fund_kpi_product_code").upper(),
                "trading_calendar_code": required(raw, "trading_calendar_code").upper(),
